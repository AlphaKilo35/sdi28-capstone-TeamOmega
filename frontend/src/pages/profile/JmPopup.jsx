...
function JmPopup ({onSetPopup, changeJm, originJm, adminStatus, jmChanged}) {
    ...
    return (
        <div className="bg-gray-800 border border-gold-600 p-4 rounded-md text-2xl text-center flex flex-col space-y-8 popup-overlay">
            ...
            <div>
                <select name="jm" id="jm" className="w-full pl-2 pr-4 py-2 text-black border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-gold-400" onChange={(e) => setSelectedValue(e.target.value)}>
